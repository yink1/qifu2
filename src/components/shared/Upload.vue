...
<script>
  ...
  export default {
    ...
    props: {
      ...
      domain: {
        type: String,
        default: 'http://cdn-qifu.thinkwit.com/'
      },
      bucket_name: {
        type: String,
        default: 'qifutest'
    ...
    mounted () {
      ...
      this.uploader = Qiniu.uploader({
        ...
        uptoken_url: 'http://qifuapi.thinkwit.com/api/qiniu/getToken',
        ...
        init: {
          ...
          'FileUploaded': function (up, file, info) {
            ...
            var sourceLink = _this.domain + '/' + res.key // 获取上传成功后的文件的Url
            _this.$emit('setUploadedFileInfo', _this.browse_button, file.name, sourceLink)
          },
